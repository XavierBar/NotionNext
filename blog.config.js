...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'ef348246cd584bef925c8cde556ec69a',
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250800号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250800/', // 备案查询链接，如果用了萌备等备案请在这里填写
